...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-primary text-primary-foreground border-t-4 border-destructive mt-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm md:text-base", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Educational Fan Page" }),
      " • Not affiliated with Formula 1®"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm flex items-center justify-center gap-2 flex-wrap", children: [
      "© 2025. Built with",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-4 h-4 fill-destructive text-destructive inline-block" }),
      " ",
      "using",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-primary-foreground/80 max-w-2xl mx-auto", children: "This is a fan-made educational resource created to share knowledge about Formula 1 aerodynamics. All technical information is for educational purposes only." })
  ] }) }) });
}
function Header() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-gradient-to-r from-primary via-destructive to-primary border-b-4 border-destructive shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-5xl font-bold text-primary-foreground tracking-tight", children: "F1 Aerodynamics Explained" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-primary-foreground/90 mt-3 text-sm md:text-base font-medium tracking-wide", children: "The Science of Speed" })
  ] }) });
}
...
function TopicDetail({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-12 max-w-4xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl md:text-5xl font-bold text-foreground pb-4 border-b-4 border-destructive inline-block", children: title })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-12 rounded-xl overflow-hidden border-2 border-border shadow-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        src: imageSrc,
        alt: imageAlt,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "prose-like space-y-5 text-foreground/90 leading-relaxed text-base md:text-lg", children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 pt-8 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
        asChild: true,
        variant: "outline",
...
const Route$3 = createFileRoute("/downforce")({
...
function DownforcePage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    TopicDetail,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Downforce is the aerodynamic force that acts perpendicular to the direction of travel, pushing an F1 car downward onto the track surface. Unlike conventional lift that aircraft use to fly, F1 cars use inverted wing profiles to generate this negative lift — keeping the car glued to the tarmac at extreme speeds." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The primary sources of downforce on a modern F1 car are the front wing, rear wing, the underbody floor, and the diffuser. Each element works in concert to build and channel high-pressure air above the car while creating low pressure beneath it. The greater the pressure differential, the more downforce is produced." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "At speeds of around 200 mph (320 km/h), a contemporary F1 car can generate downforce roughly equal to 5 times its own weight — approximately 3,500–4,000 kg of downward pressure on a car that weighs just 798 kg. This is why F1 cars can corner at lateral G-forces exceeding 5g; the tyres are pushed so hard into the surface that the friction force becomes enormous." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The 2022 technical regulations introduced ground effect aerodynamics, bringing back the underbody tunnels last seen in the early 1980s. These tunnels accelerate airflow beneath the car, generating huge amounts of downforce with less aerodynamic drag than traditional wing-based solutions — a fundamentally more efficient approach." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: 'The downforce-drag trade-off is central to F1 car setup. At Monaco, teams run maximum downforce for tight, slow corners. At Monza — the "Temple of Speed" — teams strip downforce to the absolute minimum to maximize straight-line velocity. Getting this balance right can mean the difference between pole position and mid-grid.' })
      ]
    }
  );
}
const Route$2 = createFileRoute("/drag")({
  component: DragPage
});
function DragPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    TopicDetail,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Aerodynamic drag is the resistive force that opposes an F1 car's forward motion through the air. It is the unavoidable cost of generating downforce: wings that push the car down also push back against forward movement. Understanding and minimising drag is one of the most critical challenges in F1 aerodynamic design." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "Drag arises from two main sources. ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Pressure drag" }),
          " is created by the difference in air pressure between the front and rear of the car — high pressure at the front stagnation point, low pressure in the turbulent wake behind the car. ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Friction drag" }),
          " comes from the viscosity of air flowing over the car's surfaces. In F1, pressure drag dominates and is primarily determined by the car's cross-sectional area and shape."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Teams combat drag through meticulous shaping of every surface. The car's bodywork features carefully sculpted sidepods, smooth underfloors, and tightly packaged rear ends to minimise the turbulent wake. Bargeboards and vanes redirect airflow around high-drag areas like the wheels, which alone account for a significant portion of total drag due to their exposed, rotating nature." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The Drag Reduction System (DRS), introduced in 2011, gives drivers a regulated way to temporarily reduce drag during races. When activated in designated DRS zones on straights, the upper flap of the rear wing opens by up to 50mm, reducing drag by around 10–15 drag counts and adding roughly 10–12 km/h of top speed — enough to set up or defend an overtake." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Computational Fluid Dynamics (CFD) and wind tunnel testing are the primary tools for drag optimisation. Teams run thousands of CFD simulations per week, analysing airflow visualisations to identify separation points, vortex structures, and wake profiles. Every aerodynamic update submitted through the season must demonstrate a net gain in the downforce-to-drag ratio." })
      ]
    }
  );
}
...
function AeroSection({
    ...
    Card,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-bold text-foreground pb-3 border-b-2 border-destructive inline-block", children: title }),
          to && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 text-sm font-medium text-destructive opacity-0 group-hover:opacity-100 transition-opacity duration-200", children: [
            "Explore ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: imagePosition === "right" ? "md:col-start-2" : "", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden rounded-lg border border-border shadow-md", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: imageSrc,
                  alt: imageAlt,
  ...
  if (to) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "scroll-mt-20 group", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        to,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "scroll-mt-20", children: card });
}
const Route$1 = createFileRoute("/")({
  component: HomePage
});
function HomePage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-12 max-w-6xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-16 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed", children: "Formula 1 cars are engineering marvels that harness aerodynamic principles to achieve incredible performance. Understanding the science behind downforce, drag, and wing design reveals how these machines defy physics at speeds exceeding 200 mph." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-4 italic", children: "Click any topic below to explore in depth →" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        AeroSection,
        {
          title: "Downforce",
          ...
          to: "/downforce",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/90 leading-relaxed mb-4", children: "Downforce is the aerodynamic force that pushes an F1 car down onto the track, dramatically increasing grip and cornering speeds. Generated primarily by the front and rear wings, floor, and diffuser, downforce allows drivers to take corners at speeds that would otherwise be impossible." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/90 leading-relaxed", children: "Modern F1 cars can generate up to 5 times their own weight in downforce at high speeds. The challenge is balancing maximum downforce with minimal drag to optimize both cornering and straight-line speed." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        AeroSection,
        {
          ...
          to: "/drag",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/90 leading-relaxed mb-4", children: "Aerodynamic drag is the resistance force that opposes an F1 car's motion through the air. While downforce is essential for cornering, it comes at the cost of increased drag, which reduces top speed and acceleration." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/90 leading-relaxed", children: "Engineers use sophisticated CFD and wind tunnel testing to minimize drag while maintaining necessary downforce. The DRS system allows drivers to reduce drag on straights, providing a significant speed advantage for overtaking." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        AeroSection,
        {
          ...
          to: "/wings",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/90 leading-relaxed mb-4", children: "The front and rear wings are the most visible aerodynamic elements on an F1 car, each serving distinct but complementary purposes. The front wing generates downforce for the front axle and conditions airflow for the rest of the car." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/90 leading-relaxed", children: "Teams adjust wing angles throughout a race weekend to suit different track characteristics — high downforce for Monaco's tight corners, low drag for Monza's long straights." })
          ]
        }
      )
    ] })
...
const Route2 = createFileRoute("/wings")({
  component: WingsPage
});
function WingsPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    TopicDetail,
    {
      ...
      imageAlt: "F1 Front and Rear Wings Diagram",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Wings are the most iconic aerodynamic elements on a Formula 1 car — highly visible, aggressively styled, and absolutely critical to performance. Both the front and rear wings work as inverted aerofoils: their curved profiles generate low pressure above and high pressure below, producing the downforce that defines F1 handling." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "The ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "front wing" }),
          " is the first point of contact with undisturbed air, making it the most sensitive aerodynamic component. It generates roughly 25–30% of the car's total downforce while simultaneously conditioning the airflow for every other aerodynamic element downstream. Multi-element front wings feature several flaps stacked at precise angles, with endplates that sculpt airflow around the front tyres — one of the single largest sources of turbulence and drag on the car."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "The ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "rear wing" }),
          " is the dominant downforce generator, typically producing 35–40% of the car's total downforce. It sits high above the car to access clean, undisturbed air and consists of a main plane and an adjustable upper flap. The upper flap's angle is set by engineers before the race for the required downforce level and doubles as the DRS flap, which opens on straights to reduce drag."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Wing design has evolved dramatically through F1 history. The earliest wings in the late 1960s were simple flat plates. By the 1980s and 1990s, aerodynamicists were exploiting complex multi-element designs. The 2022 regulations simplified front wing geometry and introduced large, simplified rear wings to reduce the turbulent wake and enable closer racing." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Teams develop their wings continuously across a season, submitting updates at almost every race. A single aerodynamic upgrade can be worth several tenths of a second per lap. Wing stiffness, the prevention of flexing under load, and manufacturing precision at the sub-millimetre level are as important as the design itself — tiny differences in profile can have outsized effects at 200+ mph." })
      ]
    }
  );
}
const WingsRoute = Route2.update({
  id: "/wings",
  path: "/wings",
  getParentRoute: () => Route$4
});
const DragRoute = Route$2.update({
  id: "/drag",
  path: "/drag",
  getParentRoute: () => Route$4
});
const DownforceRoute = Route$3.update({
  id: "/downforce",
  path: "/downforce",
  getParentRoute: () => Route$4
});
