      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center space-y-4">
          <p className="text-sm md:text-base">
            <span className="font-semibold">Educational Fan Page</span> • Not
          ...
          <p className="text-xs text-primary-foreground/80 max-w-2xl mx-auto">
            This is a fan-made educational resource created to share knowledge
            about Formula 1 aerodynamics. All technical information is for
